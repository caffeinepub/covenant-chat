...
export class Backend implements backendInterface {
    ...
    async clearChat(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getMessages(arg0: string, arg1: bigint | null): Promise<Array<Message>> {
        if (this.processError) {
            try {
    ...
    async setPassword(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
